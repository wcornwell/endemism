...
ausplants <- read_csv('intermediate_data/summary_current.csv')
...
num_comparisons <- ncol(cont_form) - 1  # Exclude the 'Endemic' and 'Non-endemic' columns
...
#contingency table
cont_form_f <- table(filtered$endemism_status, filtered$growth_form_simp)
...
#          herb shrub tree       herb     shrub      tree
#endemic       83    86   47  0.1712374  2.750000 -2.803319
#non-endemic  141    90  147 -0.1294433 -2.078805  2.119110
